...
- [ ] Tektronix 577 Test Adapters
- [x] Fluke 8200 Repair
- [ ] Monostable multivibrator PCB design
...
- [ ] Hydrometer
- [ ] New Tools
  - [ ] Milwaukee M18 Fuel Drill/Driver combo
  - [ ] Milwaukee M18 Fuel Router
  - [x] Milwaukee M12 ratchet 3/8 (not high speed)
  - [x] Makita Impact socket sets with vinyl organizers
  - [ ] Jigsaw (possibly M18 based)
...
- [ ] Pocket scale
- [ ] ~~6 jaw chuck (5 inch okay)~~ (Found brand new 3 jaw)
- [ ] 6 inch mill vise
